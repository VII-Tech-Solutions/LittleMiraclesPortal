...
$api->version('v1', function ($api) {
    ...
    $api->group(['namespace' => 'App\API\Controllers'], function () use ($api) {
        ...
        $api->post('/photographer/login', 'PhotographerController@login')->middleware('allowed_user:true'); // Photographer Login
        ...
        $api->post('/gifts/{id}/checkout', 'GiftController@checkout')->middleware('allowed_user:true'); // Gift Checkout
