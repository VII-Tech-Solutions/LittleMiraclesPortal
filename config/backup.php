...
$app_name = "Little Miracles API " . Str::ucfirst(env("APP_ENV", "none"));
...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            ...
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'webmaster@viitech.net'),
                'name' => env('MAIL_FROM_NAME', 'Na9eebi'),
            ],
        ],
