...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('notifications') }}'><i class='nav-icon la la-hands-helping'></i>Notifications</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('gifts') }}'><i class='nav-icon la la-hands-helping'></i>Gifts</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('packages') }}'><i class='nav-icon la la-hands-helping'></i>Packages</a></li>
